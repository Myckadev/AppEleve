...
class EleveController extends AbstractController
{
     ...
     */
    public function show(Eleve $eleve, ActiviteRepository $activiteRepository): Response
    {

        $totalActivite = count($eleve->getActivites()->toArray());
        $numberActivite = count($activiteRepository->findAll());
        $percentActivite = round(($totalActivite / $numberActivite)*100);

        return $this->render('eleve/show.html.twig', [
            'eleve' => $eleve,
            'total'=>$totalActivite,
            'percentActiviteDone' =>$percentActivite
        ]);
    }
